...
class GeneralConfig:
    ...
    def __init__(self):
        ...
        self.train_pos_reviews_file_path = os.path.join(
            ROOT, "linguistic_style_transfer_pytorch", "data", "raw", "gpt.whole")
        self.train_neg_reviews_file_path = os.path.join(
            ROOT, "linguistic_style_transfer_pytorch", "data", "raw", "scientific.whole")
...
class ModelConfig:
    ...
    def __init__(self):
        ...
        self.vocab_size = 60003
        self.epochs = 70
        # batch setting
        self.batch_size = 128 * 2
        # layer sizes
        self.embedding_size = 600 * 2
        self.hidden_dim = 516 * 2
        self.style_hidden_dim = 16 * 2
        self.content_hidden_dim = 256 * 2
        # generative embedding dim = style_hidden_dim + content_hidden_dim
        self.generative_emb_dim = self.style_hidden_dim + self.content_hidden_dim
        self.num_style = 2
        self.content_bow_dim = 7526 * 2
        # dropout
        self.dropout = 0.8
