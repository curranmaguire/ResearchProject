...
#rm -rf $OUTPUT_PATH/data-bin/label
fairseq-preprocess \
    --only-source \
...
echo "Training file length:"
wc -l "$OUTPUT_PATH/train.label"
wc -l "$OUTPUT_PATH/train.bpe"

echo "Validation file length:"
wc -l "$OUTPUT_PATH/valid.bpe"
wc -l "$OUTPUT_PATH/valid.label"