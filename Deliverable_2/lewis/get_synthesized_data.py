...
#from transformers import BartModel as BARTModel
...
if __name__ == "__main__":
    ...
    parser.add_argument("--d1_model_path", type=str, metavar="STR", default='data/bart-denoising/gpt-sci/gpt/checkpoints')
    parser.add_argument("--d2_model_path", type=str, metavar="STR", default='data/bart-denoising/gpt-sci/sci/checkpoints')
    ...
    d1_path = os.path.dirname(args.d1_model_path)
    d1_data_bin = "/".join(args.d1_model_path.split("/")[:-2]+["data-bin"])
    if d1_path == args.d1_model_path:
        d1_path = "."

    d2_path = os.path.dirname(args.d2_model_path)
